    ...
    data () {
      return {
        playlist: [
          ...
          {title: "Foule_Sentimentale", artist: "DJ Yankovski", howl: null, display: true},
          {title: "Les_Rois_Du_Monde", artist: "DJ Yankovski", howl: null, display: true},
          {title: "Ландыши", artist: "DJ Yankovski", howl: null, display: true},
          {title: "i_am_sexy_and_i_know_it", artist: "true", howl: null, display: true}
        ],
        selectedTrack: null,
        index: 0,
        playing: false,
